...
def handler_namespace(fake_http: FakeHTTP) -> dict[str, object]:
    namespace: dict[str, object] = {
        ...
        "_private_turn_trace_start": lambda *args, **kwargs: None,
        "_private_turn_trace_append": lambda *args, **kwargs: None,
        "_private_turn_trace_checkpoint": lambda *args, **kwargs: None,
