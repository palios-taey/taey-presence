...
- Use the target form written in the card. An element key must be an exact mapped singleton from the immediately preceding fresh observation. A transitional ref must come from that same observation.
