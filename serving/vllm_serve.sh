...
#     TAEY_STRUCTURED_OUTPUTS_CONFIG (default: xgrammar with no free whitespace)
#
...
STRUCTURED_OUTPUTS_CONFIG="${TAEY_STRUCTURED_OUTPUTS_CONFIG:-{\"backend\":\"xgrammar\",\"disable_any_whitespace\":true}}"
